...
class Program 
{
    static void Main() 
    {
        ...
        // ทดสอบการ verify
        Console.WriteLine("\n=== Verification Test ===");
        Console.WriteLine($"admin123 verify: {BCrypt.Net.BCrypt.Verify(adminPassword, adminHash)}");
        Console.WriteLine($"staff123 verify: {BCrypt.Net.BCrypt.Verify(staffPassword, staffHash)}");
